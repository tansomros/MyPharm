            ...
            Select Case ButtonPressed.ID
                ...
                Case "imgDel"
                    If ctlL.LocationChain_Delete(e.CommandArgument) Then
                        acc.User_GenLogfile(Request.Cookies("UserID").Value, ACTTYPE_DEL, "LocationChain", "ลบชื่อกลุ่มร้านยา :" & txtName.Text, "service", Environment.MachineName, GetIPAddress())
